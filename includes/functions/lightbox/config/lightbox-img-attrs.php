...
function pipe_get_img_lightbox_reat($id, $is_thumb, $size_to_serve, $class, $data_index)
{
    ...
    $image = '
        ...
        loading="lazy"
        class="' . $class . '"
        width="' . pipe_img_new_size_plugin_rea($attachment, $size_to_serve)['width'] . '" 
        height="' . pipe_img_new_size_plugin_rea($attachment, $size_to_serve)['height'] . '" 
        src="' . $attachment->guid . '"
        srcset="' . $img_srcset . '"        
        ...
        sizes="
            (max-width: 576px) ' . pipe_img_srcset_plugin_rea($img_srcset)['small'] . 'vw,
            (max-width: 992px) ' .  pipe_img_srcset_plugin_rea($img_srcset)['medium'] . 'vw,
            (max-width: 1300px) ' .  pipe_img_srcset_plugin_rea($img_srcset)['large'] . 'vw,
            ' .  pipe_img_srcset_plugin_rea($img_srcset)['medium'] . 'vw" >
    ';
...
function pipe_img_srcset_plugin_rea($img_srcset)
{
...
function pipe_img_new_size_plugin_rea($attachment, $size_to_serve)
{
    /*
